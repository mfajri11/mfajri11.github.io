import { BuiltInIcons } from "node_modules/astro-pure/libs/icons";





export const AddedIcons = {
  // mingcute:download-lin
  download:
...
export const Icons = {...BuiltInIcons, ...AddedIcons}